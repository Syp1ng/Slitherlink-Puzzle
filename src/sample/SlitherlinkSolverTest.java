...
class SlitherlinkSolverTest {
    ...
    void nextStep() {
        ...
        gameField = new GameField(exampleNoSolution);
        assertTrue(gameField.stepCollectionEmpty(), "this function should safe the steps in a collection, but theres no solution -->empty");
    }
    ...
    void getStartingPoint() {
        ...
        assertEquals(null,solver.getStartingPoint(gamefield), "in this example no starting point");
    }
