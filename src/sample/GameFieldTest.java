...
class GameFieldTest {
    ...
    @Test //addSolutionStep, stepCollectionEmpty, getNextStep
    void SolutionSteps() {
        ...
        assertTrue(!gamefield.stepCollectionEmpty(), "Collection should now be filled");
        ...
        assertTrue(!gamefield.stepCollectionEmpty(), "Collection should not be empty");
        p = gamefield.getNextStep();
